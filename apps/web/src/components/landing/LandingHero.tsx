...
export function LandingHero() {
  ...
  // Parallax scroll — gambar zoom & konten naik seiring hero tergulir.
  ...
  // Parallax mouse — bg bergerak halus mengikuti kursor.
  ...
  return (
    // Framed: gambar "di dalam" latar terang, sudut membulat + bayangan (selaras Alur Program)
    <section className="bg-background px-3 pb-6 pt-3 sm:px-4 sm:pb-10">
      ...
      >
        {/* Background full-bleed di dalam frame (mouse parallax di wrapper, scroll zoom di img) */}
        <motion.div style={{ x: bgMX, y: bgMY }} className="absolute inset-0 z-0">
          <motion.img
        ...
        >
          ...
          >
            Dana publik untuk <span className="text-gradient">setiap warga.</span>
          </motion.h1>
          <motion.p
          ...
          >
            Bangun, pantau, dan buktikan setiap rupiah anggaran — tanpa bisa dicurangi, tanpa perlu percaya siapa pun.
          </motion.p>
          ...
          >
            ...
            />
            <button type="submit" className="flex items-center gap-1 rounded-xl bg-white px-4 py-2 text-sm font-medium text-[#0b1220] transition-transform hover:scale-[1.03]">
