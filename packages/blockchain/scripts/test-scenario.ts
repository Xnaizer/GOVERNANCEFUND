...
async function main() {
  ...
  function logTest(
    ...
    console.log(
      `[ ${actor.padEnd(12)}]: ${action.padEnd(65)} ${status} ${note}`,
    );
  }
  ...
  console.log(
    "GOVERNANCEFUND: COMPLETE END-TO-END BFT GOVERNANCE & ANTI-CORRUPTION SYSTEM AUDIT",
  );
  console.log(
    "======================================================================================\n",
  );
  ...
  const web3Governance = (await Web3Governance.deploy(
    tokenAddress,
    rootAdmin.address,
  )) as unknown as any;
  ...
  logTest(
    "System",
    "Deploy RupiahToken, TrustedGatewayBurner, and Web3Governance",
    true,
  );
  logTest(
    "System",
    "Lock contract links (setGovernace and setGateway) permanently",
    true,
  );
  ...
  await (
    await web3Governance
      .connect(rootAdmin)
      .proposeRoleGrant(admin2.address, ADMIN_ROLE)
  ).wait();
  await (
    await web3Governance.connect(rootAdmin).voteRoleProposal(voteId)
  ).wait();
  voteId++;
  logTest(
    "Root Admin",
    "Propose & vote ADMIN_ROLE for Admin 2 (BFT Threshold 1/1)",
    true,
    "- Admin 2 Active",
  );
  ...
  await (
    await web3Governance
      .connect(admin2)
      .proposeRoleGrant(admin3.address, ADMIN_ROLE)
  ).wait();
  ...
  logTest(
    "Root Admin",
    "Vote for Admin 3 Grant Admin (Progress: 2/2 Vote)",
    true,
    "- Admin 3 Active",
  );
  ...
  await (
    await web3Governance
      .connect(admin3)
      .proposeRoleGrant(admin4.address, ADMIN_ROLE)
  ).wait();
  ...
  logTest(
    "Root Admin",
    "Vote for Admin 4 Grant Admin (Progress: 2/3 Vote)",
    true,
  );
  ...
  try {
    ...
    logTest(
      "Hacker",
      "Trying to inject ilegal vote for Admin 4",
      true,
      "- Revert (Not Admin)",
    );
  }
  ...
  logTest(
    "Admin 2",
    "Vote for Admin 4 Grant Admin (Progress: 3/3 Vote)",
    true,
    "- Admin 4 Active",
  );
  ...
  await (
    await web3Governance
      .connect(rootAdmin)
      .proposeRoleGrant(admin5.address, ADMIN_ROLE)
  ).wait();
  await (
    await web3Governance.connect(rootAdmin).voteRoleProposal(voteId)
  ).wait();
  logTest(
    "Root Admin",
    "Vote for Admin 5 Grant Admin (Progress: 1/3 Vote)",
    true,
  );
  ...
  logTest(
    "Admin 3",
    "Vote for Admin 5 Grant Admin (Progress: 3/3 Vote)",
    true,
    "- Admin 5 Active. Total Admins = 5",
  );
  ...
  await (
    await web3Governance
      .connect(rootAdmin)
      .proposeRoleDevote(admin5.address, ADMIN_ROLE)
  ).wait();
  await (
    await web3Governance.connect(rootAdmin).voteRoleProposal(voteId)
  ).wait();
  logTest(
    "Root Admin",
    "Vote for Admin 5 Revoke Admin (Progress: 1/4 Vote)",
    true,
  );
  ...
  logTest(
    "Admin 2",
    "Vote for Admin 5 Revoke Admin (Progress: 2/4 Vote)",
    true,
  );
  ...
  logTest(
    "Admin 3",
    "Vote for Admin 5 Revoke Admin (Progress: 3/4 Vote)",
    true,
  );
  ...
  logTest(
    "Admin 4",
    "Vote for Admin 5 Revoke Admin (Progress: 4/4 Vote)",
    true,
    "- Admin 5 Revoked. Total Admins returns to 4",
  );
  ...
  await (
    await web3Governance
      .connect(rootAdmin)
      .proposeRoleGrant(validator1.address, VALIDATOR_ROLE)
  ).wait();
  await (
    await web3Governance.connect(rootAdmin).voteRoleProposal(voteId)
  ).wait();
  ...
  logTest(
    "Admin 1,2,3",
    "Vote for Validator 1 Grant Validator (3/4 Vote)",
    true,
    "- Validator 1 Active",
  );
  voteId++;
  ...
  await (
    await web3Governance
      .connect(admin2)
      .proposeRoleGrant(validator2.address, VALIDATOR_ROLE)
  ).wait();
  await (
    await web3Governance.connect(rootAdmin).voteRoleProposal(voteId)
  ).wait();
  ...
  logTest(
    "Admin 1,3,4",
    "Vote for Validator 2 Grant Validator (3/4 Vote)",
    true,
    "- Validator 2 Active",
  );
  voteId++;
  ...
  await (
    await web3Governance
      .connect(admin3)
      .proposeRoleGrant(validator3.address, VALIDATOR_ROLE)
  ).wait();
  await (
    await web3Governance.connect(rootAdmin).voteRoleProposal(voteId)
  ).wait();
  ...
  logTest(
    "Admin 1,2,4",
    "Vote for Validator 3 Grant Validator (3/4 Vote)",
    true,
    "- Validator 3 Active",
  );
  voteId++;
  ...
  await (
    await web3Governance
      .connect(rootAdmin)
      .proposeRoleGrant(auditor1.address, AUDITOR_ROLE)
  ).wait();
  await (await web3Governance.connect(admin2).voteRoleProposal(voteId)).wait();
  await (await web3Governance.connect(admin3).voteRoleProposal(voteId)).wait();
  await (await web3Governance.connect(admin4).voteRoleProposal(voteId)).wait();
  logTest(
    "Admin 2,3,4",
    "Vote for Auditor 1 Grant Auditor (3/4 Vote)",
    true,
    "- Auditor 1 Active",
  );
  voteId++;
  ...
  await (
    await web3Governance
      .connect(rootAdmin)
      .proposeRoleGrant(auditor2.address, AUDITOR_ROLE)
  ).wait();
  await (await web3Governance.connect(admin2).voteRoleProposal(voteId)).wait();
  await (await web3Governance.connect(admin3).voteRoleProposal(voteId)).wait();
  await (await web3Governance.connect(admin4).voteRoleProposal(voteId)).wait();
  logTest(
    "Admin 2,3,4",
    "Vote for Auditor 2 Grant Auditor (3/4 Vote)",
    true,
    "- Auditor 2 Active",
  );
  voteId++;
  ...
  await (
    await web3Governance
      .connect(rootAdmin)
      .proposeRoleGrant(dummyUser, VALIDATOR_ROLE)
  ).wait();
  const voteId1 = currentNonce;
  await (
    await web3Governance
      .connect(rootAdmin)
      .proposeRoleGrant(dummyUser, AUDITOR_ROLE)
  ).wait();
  ...
  await (
    await web3Governance.connect(rootAdmin).voteRoleProposal(voteId1)
  ).wait();
  ...
  await (
    await web3Governance.connect(rootAdmin).voteRoleProposal(voteId2)
  ).wait();
  await (await web3Governance.connect(admin2).voteRoleProposal(voteId2)).wait();
  try {
    await (
      await web3Governance.connect(admin3).voteRoleProposal(voteId2)
    ).wait();
    logTest(
      "System",
      "Testing double-grant prevention (Validator + Auditor)",
      false,
    );
  } catch (e) {
    logTest(
      ...
      "Testing double-grant prevention (Validator + Auditor)",
      true,
      "- Revert (Candidate now holds a role)",
    );
  }
  ...
  try {
    await web3Governance
      .connect(rootAdmin)
      .proposeRoleGrant(hacker.address, PIC_ROLE);
    logTest("Root Admin", "Trying to grant Fake PIC to proposal role", false);
  } catch (e) {
    logTest(
      "Root Admin",
      "Trying to grant Fake PIC to proposal role",
      true,
      "- Revert cannot propose PIC role",
    );
  }

  // Direct grant from Admin
  await (
    await web3Governance.connect(rootAdmin).grantPicRole(pic1.address)
  ).wait();
  logTest(
    "Root Admin",
    "Execute direct grant PIC role to PIC 1",
    true,
    "- PIC 1 Active",
  );
  ...
  try {
    ...
    logTest(
      "Hacker",
      "Trying to directly execute grantPicRole to himself",
      false,
    );
  } catch (e) {
    logTest(
  ...
  await (
    await web3Governance.connect(admin3).grantPicRole(fakePIC.address)
  ).wait();
  logTest(
    "Admin 3",
    "Execute direct grant PIC role to fake PIC",
    true,
    "- fake PIC Active but cannot bypass voting from Multi Validator and Auditor",
  );
  ...
  await (
    await web3Governance
      .connect(pic1)
      .submitProposal(programId, programHash, totalBudget, milestoneCount)
  ).wait();
  logTest(
    "PIC 1",
    "Submit Funding Proposal  (ID: 1, Budget: 5 Mill, 2 Milestone)",
    true,
    "- Status: PENDING",
  );
  ...
  await (
    await web3Governance.connect(validator1).voteProposal(programId)
  ).wait();
  await (
    await web3Governance.connect(validator2).voteProposal(programId)
  ).wait();
  ...
  await (
    await web3Governance.connect(validator3).voteProposal(programId)
  ).wait();
  logTest(
    "Validator 3",
    "Approve PIC 1 Program (Progress: 3/3)",
    true,
    "- Program Approved",
  );
  ...
  logTest(
    "Fake PIC",
    "Submit Funding Proposal  (ID: 2, Budget: 1 Mill, 2 Milestone)",
    true,
    "- Status: PENDING but no one vote",
  );

  // Root Admin notice Admin 3 grant role to fake PIC so he revoked it.
  await (
    await web3Governance.connect(rootAdmin).revokePicRole(fakePIC.address)
  ).wait();
  logTest(
    "Root Admin",
    "Revoke fake PIC role after suspicious proposal",
    true,
    "- Proposal ID 2 stuck PENDING, no validator votes",
  );

  // PIC 1 create another program but not one vote until 7 days
  const anotherprogramId = 3;
  const anotherprogramHash = ethers.id(
    "Proposal_Anti_Korupsi_IDR_2026 Another",
  );
  ...
  await (
    await web3Governance
      ...
      .submitProposal(
        ...
        anotherprogramHash,
        anothertotalBudget,
        anothermilestoneCount,
      )
  ).wait();
  logTest(
    "PIC 1",
    "Submit Another Funding Proposal  (ID: 3, Budget: 1 Mill, 3 Milestone)",
    true,
    "- Status: PENDING",
  );
  ...
  try {
    await (
      await web3Governance.connect(validator1).voteProposal(anotherprogramId)
    ).wait();
    logTest(
      "Validator 1",
      "Trying to vote program that already expired",
      false,
    );
  } catch (e) {
    logTest(
      ...
      "Trying to vote program that already expired",
      true,
      "- Revert (Program vote phase is expired)",
    );
  }
  ...
  try {
    ...
    logTest(
      "PIC 1",
      "Trying to release fund quota with incorrect role signature",
      false,
    );
  } catch (e) {
    logTest(
      ...
      "Trying to release fund quota with incorrect role signature",
      true,
      "- Revert (Role validation refused)",
    );
  }
  ...
  try {
    ...
    logTest(
      "PIC 1",
      "Trying to release with tampered milestoneBudget",
      true,
      "- Revert (signature no longer matches altered data)",
    );
  }
  ...
  logTest(
    "PIC 1",
    "Milestone 1 release fund with 3 verified signature EIP 712",
    true,
    "- Milestone now is DRAWABLE",
  );
  ...
  logTest(
    "System",
    "Verify program state after milestone release",
    true,
    `- Status: ${prop.status} (2=DRAWABLE), Allocated: ${ethers.formatEther(
      prop.currentAllocatedBalance,
    )} eIDR`,
  );
  ...
  try {
    ...
    logTest(
      "Hacker",
      "Trying to withdraw fund in program id 1",
      true,
      "- Revert (Not same PIC wallet)",
    );
  }
  ...
  try {
    ...
    logTest(
      "PIC 1",
      "Trying to withdraw fund excess the limit",
      true,
      "- Revert (Amount excess the limit)",
    );
  }
  ...
  logTest(
    "PIC 1",
    "Withdraw 1 Mill eIDR from milestone",
    true,
    "- 1 Mill eIDR send to PIC Wallet",
  );
  ...
  logTest(
    "System",
    "Checking PIC's eIDR Amount",
    true,
    `- PIC's eIDR : ${ethers.formatEther(pic1Balance)} eIDR`,
  );
  ...
  logTest(
    "System",
    "Checking remaining balance to withdraw in program id 1",
    true,
    `- Status: ${
      prop1.status
    } (2=DRAWABLE), Total Allocated Fund = ${ethers.formatEther(
      prop1.totalAllocatedSoFar,
    )} eIDR, Remaining Fund = ${ethers.formatEther(
      prop1.currentAllocatedBalance,
    )} eIDR`,
  );
  ...
  logTest(
    "PIC 1",
    "Withdraw 1.5 Mill eIDR from milestone",
    true,
    "- 1.5 Mill eIDR send to PIC Wallet",
  );
  ...
  logTest(
    ...
    "Checking PIC's eIDR Amount",
    true,
    `- PIC's eIDR : ${ethers.formatEther(pic1Balance2)} eIDR`,
  );
  ...
  logTest(
    ...
    `- Status: ${
      prop2.status
    } (3=MILESTONE_ACHIEVED), Total Allocated Fund = ${ethers.formatEther(
      prop2.totalAllocatedSoFar,
    )} eIDR, Remaining Fund = ${ethers.formatEther(
      prop2.currentAllocatedBalance,
    )} eIDR`,
  );
  ...
  const payload1Bad = {
    programId,
    milestoneIndex: milestoneIndex1,
    milestoneBudget: ethers.parseEther("2500000"),
    evidenceHash: evidenceHash1,
  };

  const sigAdminBad = await rootAdmin.signTypedData(domain, types, payload1Bad);
  const sigValidatorBad = await validator2.signTypedData(
    domain,
    types,
    payload1Bad,
  );
  const sigAuditorBad = await auditor1.signTypedData(
    domain,
    types,
    payload1Bad,
  );
  ...
  try {
    ...
    logTest(
      "PIC 1",
      "Trying to release milestone 1 with few same signers (collusion)",
      false,
    );
  } catch (e) {
    logTest(
  ...
  logTest(
    "PIC 1",
    "Release milestone 1 with different signers",
    true,
    "- Milestone 1 DRAWABLE",
  );
  ...
  await (
    await web3Governance.connect(auditor1).forceFreezeProgram(programId)
  ).wait();
  ...
  logTest(
    "System",
    "Checking status program with id 1",
    true,
    `- Status: ${prop3.status}  (4 = FROZEN)`,
  );
  ...
  try {
    ...
    logTest(
      "PIC 1",
      "Trying to force withdrawal fund with Frozen status condition",
      false,
    );
  } catch (e) {
    logTest(
  ...
  await (
    await web3Governance.connect(pic1).proposeUnfreezeAppeal(programId)
  ).wait();
  logTest(
    "PIC 1",
    "Submit unfreeze appeal",
    true,
    "- Appeal opened for voting",
  );
  ...
  try {
    ...
    logTest(
      "PIC 1",
      "Trying to spam unfreeze appeal to reset votes",
      true,
      "- Revert (Appeal already in progress)",
    );
  }
  ...
  try {
    ...
    logTest(
      "Hacker",
      "Voting the frozen program appeal",
      true,
      "- Revert (Not Validator)",
    );
  }
  ...
  await (
    await web3Governance.connect(validator1).voteUnfreezeAppeal(programId, true)
  ).wait();
  await (
    await web3Governance.connect(validator2).voteUnfreezeAppeal(programId, true)
  ).wait();
  ...
  await (
    await web3Governance.connect(validator3).voteUnfreezeAppeal(programId, true)
  ).wait();
  logTest(
    "Validator 3",
    "Vote APPROVE unfreeze (3/3)",
    true,
    "- Program restored to DRAWABLE",
  );
  ...
  logTest(
    "System",
    "Checking program status after unfreeze",
    true,
    `- Status: ${prop4.status} (2=DRAWABLE)`,
  );
  ...
  await (
    await web3Governance.connect(validator1).voteProposal(fraudProgramId)
  ).wait();
  await (
    await web3Governance.connect(validator2).voteProposal(fraudProgramId)
  ).wait();
  await (
    await web3Governance.connect(validator3).voteProposal(fraudProgramId)
  ).wait();
  logTest(
    "System",
    "Setup program 4: submitted & approved",
    true,
    "- Status: APPROVED",
  );
  ...
  const fraudPayload = {
    programId: fraudProgramId,
    milestoneIndex: 0,
    milestoneBudget: ethers.parseEther("3000000"),
    evidenceHash: fraudEvidence,
  };
  const fSigAdmin = await rootAdmin.signTypedData(domain, types, fraudPayload);
  const fSigValidator = await validator1.signTypedData(
    domain,
    types,
    fraudPayload,
  );
  ...
  logTest(
    "System",
    "Setup program 4: milestone 0 released",
    true,
    "- Status: DRAWABLE",
  );
  ...
  await (
    await web3Governance.connect(auditor1).forceFreezeProgram(fraudProgramId)
  ).wait();
  logTest(
    "Auditor 1",
    "Freeze program 4 on fraud suspicion",
    true,
    "- Status: FROZEN",
  );
  ...
  // PIC appeal
  await (
    await web3Governance.connect(pic1).proposeUnfreezeAppeal(fraudProgramId)
  ).wait();
  logTest(
    "PIC 1",
    "Submit unfreeze appeal for program 4",
    true,
    "- Appeal opened",
  );
  ...
  await (
    await web3Governance
      .connect(validator1)
      .voteUnfreezeAppeal(fraudProgramId, false)
  ).wait();
  await (
    await web3Governance
      .connect(validator2)
  ...
  logTest(
    "System",
    "Checking program 4 status",
    true,
    `- Status: ${fraudProp.status} (6=FRAUD_CONFIRMED)`,
  );
  ...
  try {
    ...
    logTest(
      "PIC 1",
      "Trying to withdraw after fraud confirmed",
      true,
      "- Revert (Status: FRAUD_CONFIRMED, funds locked forever)",
    );
  }
  ...
  await (
    await web3Governance.connect(validator1).voteProposal(expiredProgramId)
  ).wait();
  await (
    await web3Governance.connect(validator2).voteProposal(expiredProgramId)
  ).wait();
  await (
    await web3Governance.connect(validator3).voteProposal(expiredProgramId)
  ).wait();

  const expEvidence = ethers.id("Expired_Milestone_0");
  const expPayload = {
    programId: expiredProgramId,
    milestoneIndex: 0,
    milestoneBudget: ethers.parseEther("2000000"),
    evidenceHash: expEvidence,
  };
  const eSigAdmin = await rootAdmin.signTypedData(domain, types, expPayload);
  const eSigValidator = await validator1.signTypedData(
    domain,
    types,
    expPayload,
  );
  ...
  await (
    await web3Governance.connect(auditor1).forceFreezeProgram(expiredProgramId)
  ).wait();
  await (
    await web3Governance.connect(pic1).proposeUnfreezeAppeal(expiredProgramId)
  ).wait();
  logTest(
    "System",
    "Setup program 5: frozen & appeal opened",
    true,
    "- Status: FROZEN",
  );
  ...
  try {
    await (
      await web3Governance
        .connect(validator1)
        .voteUnfreezeAppeal(expiredProgramId, true)
    ).wait();
    logTest("Validator 1", "Trying to vote after appeal deadline", false);
  } catch (e) {
    logTest(
      "Validator 1",
      "Trying to vote after appeal deadline",
      true,
      "- Revert (Appeal voting expired)",
    );
  }
  ...
  logTest(
    "System",
    "Checking program 5 status (unresolved)",
    true,
    `- Status: ${expiredProp.status} (4=FROZEN, stays frozen)`,
  );
  ...
  logTest(
    "System",
    "Checking Amount of eIDR Token PIC has",
    true,
    `balance : ${ethers.formatEther(pic1Balance3)} eIDR`,
  );
  ...
  try {
    await rupiahToken
      .connect(pic1)
      .transfer(hacker.address, ethers.parseEther("1000000"));
    logTest("PIC 1", "Transfer eIDR token to hacker", false);
  } catch (e) {
    logTest(
      "PIC 1",
      "Transfer eIDR token to hacker",
      true,
      "-Revert (Cannot transfer token unless to Gateway address)",
    );
  }
  ...
  await (
    await rupiahToken.connect(pic1).approve(gatewayAddress, pic1Balance3)
  ).wait();
  ...
  logTest(
    "System",
    "Total supply before redemption",
    true,
    `${ethers.formatEther(supplyBefore)} eIDR`,
  );
  ...
  logTest(
    "PIC 1",
    "requestRedemption(half) → escrow in gateway",
    true,
    `- gateway holds ${ethers.formatEther(
      escrowBal,
    )} eIDR, PIC left ${ethers.formatEther(picAfterReq)} eIDR`,
  );

  const supplyMid = await rupiahToken.totalSupply();
  logTest(
    "System",
    "Supply unchanged after request (not burned yet)",
  ...
  logTest(
    "Gateway",
    "confirmRedemption(1) → burn escrow + fiat paid",
    supplyAfterBurn === supplyBefore - half,
  ...
  logTest(
    "Gateway",
    "cancelRedemption(2) → escrow refunded to PIC",
    pic1Balance4 === rest,
